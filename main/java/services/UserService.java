...
public interface UserService {
    ...
    int getParkingIdByUserId(Integer var1);
    String getcarnumberByParkingId(Integer var1);
    String gethostnameByParkingId(Integer var1);
 int getphoneByParkingId(Integer var1);
    //表fare的sql语句
    ...
    int deletefareinfo(Integer var1);
 int updatefareinfo(fare fi);
 int getfareById(Integer var1);
